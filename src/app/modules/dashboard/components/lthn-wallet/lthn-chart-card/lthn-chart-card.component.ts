...
@Component({
  selector: 'app-lthn-chart-card',
  imports: [AngularSvgIconModule, NgApexchartsModule],
  templateUrl: './lthn-chart-card.component.html',
  styleUrl: './lthn-chart-card.component.css',
  standalone: true
})
export class LthnChartCardComponent implements OnInit, OnDestroy {
